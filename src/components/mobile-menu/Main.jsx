...
import { menu } from '@/layouts/Side-menu/app.js'

function Main(props) {
  const navigate = useNavigate()
  const location = useLocation()
  const [formattedMenu, setFormattedMenu] = useState([])
  const sideMenuStore = menu
  const mobileMenu = () => nestedMenu($h.toRaw(sideMenuStore), location)
    ...
    <>
      ...
      >
        ...
        <div className="scrollable">
          <a href="#" onClick={e => e.preventDefault()} className="mobile-menu-toggler">
            <Lucide
              icon="XCircle"
              className="w-8 h-8 text-white transform -rotate-90"
              onClick={() => {
